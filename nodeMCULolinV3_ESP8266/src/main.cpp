...
{
  printf("handleInterrupt1 %lu\n\n", millis());
}

void ICACHE_RAM_ATTR handleInterrupt()
{
  printf("handleInterrupt %lu\n\n", millis());
  handleInterrupt1();
}
...
void setup()
{
  ...
  attachInterrupt(digitalPinToInterrupt(PIN_D2), handleInterrupt, RISING);
  // attachInterrupt(digitalPinToInterrupt(PIN_D2), requestPortalConfiguration, RISING);
}
